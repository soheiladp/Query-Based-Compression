...
HTree::HTree(int fan_out, vector<double>& hist_seg, int para_begin, int para_end, double epsilon){
	Utilities util;
	...
	for(int i = para_begin; i < para_end; i ++){
		double noise;
		noise = hist_seg[i] + util.getLapNoise(lamda);
