...
//Mean-StructureFirst
void structureFirst(double* oricounts, int n, double* noicounts, int n1, double epsilon){
    ...
    ovec.resize(n);
	dp.outputNoisyCounts_StructureFirst(counts, counts_smooth_max_freq, epsilon1, epsilon2, max_freq, ovec);
